// Credits: https://github.com/devression/Pong-Game

if (window.innerWidth < 1024) {
  document.body.innerText = `Visit using a keyboard device to play🕹️`;
...
let colors = ['#059C7E', '#00E861', '#069BFF', '#E8275E', '#B027E7'];
